...
# route exercicio 20 lst2
@app.route("/ex20lst2")
def ex20lst2():
    return render_template("ex20lst2.html")


@app.route("/ex20lst2", methods=["POST"])
def ex20lst2_1():
    media = funcionalidadelst2.ex20lst2()
    return render_template("ex20lst2.html", media=media)


# route exercicio 21 lst2
@app.route("/ex21lst2")
def ex21lst2():
    return render_template("ex21lst2.html")


@app.route("/ex21lst2", methods=["POST"])
def ex21lst2_1():
    notas = funcionalidadelst2.ex21lst2()
    return render_template("ex21lst2.html", notas=notas)


# route exercicio 22 lst2
@app.route("/ex22lst2")
def ex22lst2():
    return render_template("ex22lst2.html")


@app.route("/ex22lst2", methods=["POST"])
def ex22lst2_1():
    numero = funcionalidadelst2.ex22lst2()
    return render_template("ex22lst2.html", numero=numero)


# route exercicio 23 lst2
@app.route("/ex23lst2")
def ex23lst2():
    return render_template("ex23lst2.html")


@app.route("/ex23lst2", methods=["POST"])
def ex023lst2_1():
    numero = funcionalidadelst2.ex23lst2()
